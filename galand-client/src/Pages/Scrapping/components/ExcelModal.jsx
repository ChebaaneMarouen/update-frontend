...
class ExcelExportModal extends Component {
  ...
  submit(toggleModal) {
    ...
    onSubmit({
      ...
      hatespeech : this.state.hatespeech ? this.state.hatespeech.target.value : ""
    });
    this.setState({
  ...
  render() {
    const {  before_created, after_created, after_firstCrawlTime, before_firstCrawlTime, hatespeech } = this.state;
           ...
           {source === "scraping" && <Col>
            ...
            {source === "scraping" && <Col>
              <DateTime
                  ...
                  onChange={(d) => {
                    this.onChange({
                      target: { name: "after_firstCrawlTime", value: d.valueOf() },
                    });
                  }}
            ...
            {source === "scraping" && <Col>
              <DateTime
                      ...
                      onChange={(d) => {
                        this.onChange({
                          target: { name: "before_firstCrawlTime", value: d.valueOf() },
                        });
                      }}
            ...
            </Col>   }
            {
              ...
              <Select
                  ...
                  options={hateSpeechDegrees.map((m) => ({ label: m.name, value: m._id }))}
                />
              </Col>
            }  
        </Form>
